...
class_info = {
    ...
    "Acne": {
        ...
        "CommonAreas": "Face, back, chest, and shoulders.",
        "RiskFactors": "Hormonal changes, stress, diet, genetics.",
        "Treatment": "Topical creams, antibiotics, retinoids, laser therapy."
    },
    'vasculitis': {
        "Cause": "Inflammation of blood vessels, possibly due to infections, medications",
        "Symptoms": "Red or purple spots, ulcers, pain, swelling.",
        "CommonAreas": "Legs, arms, other body parts depending on type.",
        "RiskFactors": "Autoimmune diseases, infections, certain medications.",
        "Treatment": "Corticosteroids, immunosuppressive drugs."
    },
    "Other": {
        "Cause": "Unknown or not categorized.",
        "Symptoms": "Varies based on condition.",
        "CommonAreas": "May affect any part of the body.",
        "RiskFactors": "Dependent on the specific condition.",
